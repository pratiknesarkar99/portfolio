  ...
  const companyProjects = [
    {
      ...
      projDesc: [
        `Engineered 15+ reusable React components for global 3D modeling teams, using dynamic component architecture to improve UI consistency, accelerate feature delivery, and boost app performance by 37%.`,
        `Developed and integrated a reality data management platform for visualizing IoT sensor data, optimizing state management with Context API to achieve 2x faster data retrieval and deliver ~$500K in annual client value.`,
        `Secured and optimized 20+ REST APIs in microservice architecture using Express.js, by enforcing strict validation and test-driven development principles eliminating about 30% of critical vulnerabilities.`,
        `Accelerated feature delivery through an agile proof-of-concept approach, reducing late-stage failure risk for major releases and contributing to a ~15% improvement in team delivery OKRs.`,
